<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wtwnedir.aspx.cs" Inherits="webProjesi.html.wtwnedir" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
     <title>WTW nedir</title>
    <link type="text/css"  rel="stylesheet" href="../css/wtwnedir.css" />
</head>
<body>
     <div class="header">
        <div class="logo">
    ...
    <div class="icerik">
        <img src="../img/nedirBuWTW.jpg" alt="aciklama" />
    </div>
